...
<button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModal_p<?php echo e($post->id); ?>">削除</button>
  ...
  </div><?php /**PATH /var/www/html/my_top3/resources/views/layouts/modal_delete_post.blade.php ENDPATH**/ ?>